...
// Notu kontrol eden fonksiyonu tanımladık
function noteControle() {
    // Mesaj kartındaki tüm classlari silme işlemi
...
// Not ekleme işlemi fonksiyonunu oluşturduk
function noteAdd(value) {
    saveData(value);
    checkData();
}

// Not yazma fonksiyonu işlemini gerçekleştirdik
...
// Notu kayıt etmek fonksiyonu işlemi yaptık
...
// Notu güncelleme fonksiyonu işlemi yaptık
...
// Notu silme fonksiyonu işlemi yaptık
...
// Klavye işlemlerini gerçekleştirdik
